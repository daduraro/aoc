...
namespace {
    ...
    std::optional<std::size_t> resultA(input_t in) noexcept {
    ...
    std::size_t param_resultB(const input_t& in, std::size_t max_dist) noexcept {
